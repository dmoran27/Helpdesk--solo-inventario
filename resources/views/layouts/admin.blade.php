...
//---------------------------------Establecer LEnguaje del data table
    language: {
    ...
    //----------------------------Invocar pluguins de botones de data table
    columnDefs: [{
        orderable: false,
...
//-------------------------------------------Confirmar al elimiar elemento unico de data table
...
//------------Solo Numeros
 ...
 //----------No permitir copiar cortar o pegar 
...
//--------------Solo Letras
 $('.validarletras').on('input', function (e) {
...
//--------------Solo Letras
 $('.validaremail').on('input', function (e) {
 
    if (!/b[A-Z0-9._%+-]b/i.test(this.value)){
